...
export const mockSiteContent = {
  ...
  g12Vision: {
    ...
    logo: {
      src: "/images/g12philippines_logo.png",
    ...
    intro:
      "The G12 Vision is a God-given strategy for fulfilling the Great Commission — a clear path to win people to Christ, strengthen new believers, train disciples, and send them to reach others.",
    closing:
      "Every member discipled, every disciple a leader, every leader a multiplier.",
    steps: [
      {
        title: "Win",
        description: "Reach people with the Gospel and invite others to know Jesus.",
      },
      {
        title: "Consolidate",
        description: "Care for new believers through welcome, follow-up, and cell group life.",
      },
      {
        title: "Disciple",
        description: "Teach the foundations of life in Christ — prayer, Word, and holiness.",
      },
      {
        title: "Send",
        description: "Equip leaders to multiply through cell groups and teams of twelve.",
      },
    ],
  },
  trust: {
  ...
  ministries: {
    ...
    more: {
      ...
      description:
        "Discover new ways to connect, serve, and grow as you live out your faith alongside others.",
